...
class AuthManager:
    ...
    def _get_or_refresh_token(self) -> str:
        ...
        if (
            self._token_cache and self._token_expires_at and current_time < self._token_expires_at - 60
        ):  # 60 second buffer
...
class ServiceAccountAuth:
    ...
    def __init__(self, service_account_key: str, scopes: list | None = None):
    ...
    def _get_or_refresh_service_token(self) -> str:
        ...
        # Check if we have a cached token that's still valid
        if self._token_cache and self._token_expires_at and current_time < self._token_expires_at - 60:
            return self._token_cache
