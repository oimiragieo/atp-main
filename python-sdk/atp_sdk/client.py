...
import httpx
from .models import (
    ChatMessage, ChatRequest, ChatResponse, StreamingResponse,
    ModelInfo, ProviderInfo, CostInfo, UsageStats, PolicyInfo
)
from .exceptions import (
    ATPError, AuthenticationError, RateLimitError,
    ModelNotFoundError, InsufficientCreditsError, ValidationError
)
...
class ATPClient:
    ...
    def __init__(
        ...
        timeout: float = 30.0,
        max_retries: int = 3,
        config: Optional[ATPConfig] = None
    ):
        """
    ...
    def chat_completion(
        ...
        stream: bool = False,
        **kwargs
    ) -> Union[ChatResponse, Iterator[StreamingResponse]]:
        """
...
class AsyncATPClient:
    ...
    async def chat_completion(
        ...
        stream: bool = False,
        **kwargs
    ) -> Union[ChatResponse, AsyncIterator[StreamingResponse]]:
        """
