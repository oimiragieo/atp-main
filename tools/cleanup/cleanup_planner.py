...
class CleanupPlanner:
    ...
    def _prioritize_tasks(self):
        ...
        task_groups = {"secure": [], "remove": [], "relocate": [], "refactor": []}
        ...
        self.cleanup_tasks = (
            task_groups["secure"] + task_groups["remove"] + task_groups["relocate"] + task_groups["refactor"]
        )
...
def main():
    ...
    planner.save_plan("tools/cleanup/cleanup_execution_plan.json")
