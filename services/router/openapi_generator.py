...
class APIDocumentationConfig:
    ...
    license_url: str | None = "https://www.apache.org/licenses/LICENSE-2.0"
...
class OpenAPIGenerator:
    ...
    def _initialize_default_schemas(self):
        ...
        self.custom_schemas["ChatCompletionRequest"] = {
            ...
            "properties": {
                ...
                "model": {"type": "string", "description": "Model to use for completion", "example": "gpt-4"},
                "temperature": {
                    "type": "number",
                    "minimum": 0,
                    "maximum": 2,
                ...
                "stream": {"type": "boolean", "default": False, "description": "Whether to stream responses"},
                "top_p": {
                    "type": "number",
                    "minimum": 0,
                    "maximum": 1,
        ...
        self.custom_schemas["ChatMessage"] = {
            ...
            "properties": {
                ...
                "name": {"type": "string", "description": "Optional name of the sender"},
            },
        }
        ...
        self.custom_schemas["ChatCompletionResponse"] = {
            ...
            "properties": {
                ...
                "usage": {"$ref": "#/components/schemas/Usage", "description": "Token usage information"},
            },
        }
        ...
        self.custom_schemas["ChatChoice"] = {
            ...
            "properties": {
                ...
                "message": {"$ref": "#/components/schemas/ChatMessage", "description": "Generated message"},
                "finish_reason": {
                    "type": "string",
        ...
        self.custom_schemas["Model"] = {
            ...
            "properties": {
                ...
                "permission": {"type": "array", "items": {"type": "object"}, "description": "Model permissions"},
            },
        }
    ...
    def generate_openapi_spec(
        self, app: FastAPI = None, version: str = None, include_internal: bool = False
    ) -> dict[str, Any]:
        ...
        if app:
            fastapi_openapi = get_openapi(
                title=self.config.title, version=api_version, description=self.config.description, routes=app.routes
            )
            ...
            if "components" in fastapi_openapi:
                if "schemas" in fastapi_openapi["components"]:
                    openapi_spec["components"]["schemas"].update(fastapi_openapi["components"]["schemas"])
        else:
...
<body>
    ...
    def generate_client_code(
        self, spec: dict[str, Any], language: str = "python", output_dir: str | None = None
    ) -> dict[str, str]:
