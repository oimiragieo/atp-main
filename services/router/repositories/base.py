...
class BaseRepository(Generic[ModelType], ABC):
    ...
    # Cache management
    def _get_cache_key(self, key: str | UUID | int) -> str:
        """Generate cache key."""
    ...
    def _set_cache(self, key: str, data: Any, ttl_seconds: int | None = None) -> None:
    ...
    async def get_by_tenant(
        self, tenant_id: str, page: int = 1, page_size: int = None, filters: dict[str, Any] | None = None
    ) -> list[ModelType]:
        ...
        return await self.get_all(page=page, page_size=page_size, filters=tenant_filters)

    async def count_by_tenant(self, tenant_id: str, filters: dict[str, Any] | None = None) -> int:
