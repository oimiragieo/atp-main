...
class ComplianceRepository(BaseRepository[ComplianceViolation]):
    ...
    async def get_by_violation_id(self, violation_id: str) -> Optional[ComplianceViolation]:
    ...
    async def get_violation_statistics(
        ...
        async with self.db_manager.get_session() as session:
            ...
            framework_stmt = (
                select(ComplianceViolation.framework, func.count(ComplianceViolation.id))
            ...
            severity_stmt = (
                select(ComplianceViolation.severity, func.count(ComplianceViolation.id))
            ...
            status_stmt = (
                select(ComplianceViolation.status, func.count(ComplianceViolation.id))
