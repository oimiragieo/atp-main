...
class PricingAlertManager:
    ...
    async def send_pricing_alert(
        self, provider: str, model: str, change_data: dict[str, Any], severity: str = "medium"
    ) -> bool:
    ...
    async def send_staleness_alert(self, stale_items: list[dict[str, Any]], severity: str = "low") -> bool:
    ...
    async def send_validation_alert(self, validation_result: dict[str, Any], severity: str = "medium") -> bool:
    ...
    async def send_api_error_alert(self, provider: str, error_message: str, severity: str = "high") -> bool:
    ...
    def _format_pricing_change_message(
        self, provider: str, model: str, change_data: dict[str, Any], severity: str
    ) -> str:
    ...
    def _format_staleness_message(self, stale_items: list[dict[str, Any]]) -> str:
        ...
        message = "⚠️ STALE PRICING DATA DETECTED\n"
