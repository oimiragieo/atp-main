...
class InsightsGenerator:
    ...
    async def generate_comprehensive_insights(
        ...
        try:
            ...
            high_confidence_insights = [
                insight for insight in all_insights if insight.get("confidence", 0) >= self._confidence_threshold
            ]
            ...
            self._insight_history.append(
                {
                    ...
                    "categories": list({i.get("category") for i in prioritized_insights}),
                }
            )
                    ...
                    insights.append(
                        {
                            ...
                            "metrics": {"slow_models": slow_models, "threshold_ms": 8000},
                    ...
                    insights.append(
                        {
                            ...
                            "metrics": {"peak_to_average_ratio": peak_ratio, "threshold_ratio": 5.0},
    ...
    async def _generate_cost_insights(
        self, analytics_data: dict[str, Any], business_data: dict[str, Any]
    ) -> list[dict[str, Any]]:
                    ...
                    insights.append(
                        {
                            ...
                            "metrics": {"average_daily_cost": avg_daily_cost, "trend_direction": "increasing"},
        ...
        if analytics_data:
            ...
            if patterns:
                ...
                if request_size_dist:
                    ...
                    total_requests = (
                        request_size_dist.get("small_requests", 0)
    ...
    async def _generate_reliability_insights(
        self, performance_data: dict[str, Any], anomaly_data: dict[str, Any]
    ) -> list[dict[str, Any]]:
                    ...
                    insights.append(
                        {
                            ...
                            "metrics": {"problematic_providers": problematic_providers, "error_threshold": 10.0},
                ...
                insights.append(
                    {
                        ...
                        "metrics": {
                            ...
                            "anomaly_types": list({a.get("anomaly_type") for a in high_severity_anomalies}),
                        },
                        ...
                        insights.append(
                            {
                                ...
                                "metrics": {"weekly_growth_rate": growth_rate, "growth_threshold": 0.3},
                ...
                insights.append(
                    {
                        ...
                        "confidence": 0.85,
                        "priority": min(1.0, severity_ratio * 2)
                        * self._insight_categories["security"]["priority_weight"],
                        "metrics": {
    ...
    def get_cached_insights(self) -> dict[str, Any] | None:
        ...
        if self._insights_cache and (time.time() - self._last_generation_time) < (self._update_interval_hours * 3600):
    ...
    def get_insights_history(self, days: int = 7) -> list[dict[str, Any]]:
        ...
        return [entry for entry in self._insight_history if entry["timestamp"] >= cutoff_time]
