...
class ATPMemoryStore(BaseChatMemory):
    ...
    # Memory settings
    max_token_limit: Optional[int] = Field(default=4000)
    ...
    def _prepare_headers(self) -> Dict[str, str]:
        ...
        headers = {
            ...
            "User-Agent": "ATP-LangChain-Memory/1.0.0"
        }
    ...
    def prune_messages(self, max_tokens: Optional[int] = None) -> None:
