...
from .group_chat import ATPGroupChat, ATPGroupChatManager, create_atp_group_chat
from .code_execution import ATPCodeExecutor, create_atp_code_executor
from .function_calling import (
    ATPFunctionRegistry, 
    create_builtin_function_registry,
    atp_function
)
...
class ATPAutoGenExamples:
    ...
    def __init__(
        ...
        self.code_executor = create_atp_code_executor(
...
for i in range(10):
    ...
    def group_chat_example(self) -> str:
        ...
        group_chat = create_atp_group_chat(
            agents=agents,
            max_round=8,
    ...
    def multi_agent_collaboration_example(self) -> str:
        ...
        group_chat = create_atp_group_chat(
            agents=agents,
            max_round=12,
            speaker_selection_method="load_balanced"
        )
