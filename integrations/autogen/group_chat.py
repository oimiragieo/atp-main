...
try:
    ...
    raise ImportError(
        "AutoGen is required for ATP AutoGen integration. "
...
class ATPGroupChat(GroupChat):
    ...
    def _auto_select_speaker(
        self, 
        last_speaker: ATPAutoGenAgent, 
        selector: ATPAutoGenAgent
    ) -> ATPAutoGenAgent:
    ...
    def _round_robin_select_speaker(
        self, 
        last_speaker: ATPAutoGenAgent, 
        selector: ATPAutoGenAgent
    ) -> ATPAutoGenAgent:
    ...
    def _load_balanced_select_speaker(
        ...
        candidates = [
            ...
            if self._speaker_stats[agent.name] == min_count
        ]
    ...
    def select_speaker(
        ...
        selection_func = self._selection_methods.get(
            self.speaker_selection_method, 
            self._auto_select_speaker
        )
    ...
    def export_conversation(self, format_type: str = "json") -> Union[str, Dict]:
...
class ATPGroupChatManager(GroupChatManager):
    ...
    def initiate_chat(
        self,
        recipient: ATPAutoGenAgent,
        message: Optional[Union[Dict, str]] = None,
        **kwargs
    ) -> Dict[str, Any]:
...
def create_atp_group_chat_manager(
    ...
    **kwargs
    ...
    """
    return ATPGroupChatManager(
        groupchat=groupchat,
        atp_base_url=atp_base_url,
