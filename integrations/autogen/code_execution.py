...
class ATPCodeExecutor:
    ...
    def _prepare_headers(self) -> Dict[str, str]:
        ...
        headers = {
            ...
            "User-Agent": "ATP-AutoGen-CodeExecutor/1.0.0"
        }
    ...
    def _extract_code_blocks(self, text: str) -> List[Dict[str, str]]:
        ...
        if not code_blocks:
            ...
            for line in lines:
                ...
                if (line.startswith(('def ', 'class ', 'import ', 'from ')) or
                    '=' in line and ('print(' in line or 'return ' in line) or
    ...
    async def _execute_code_via_atp(
        self, 
        code: str, 
        language: str,
            ...
            try:
                ...
                try:
                    result = loop.run_until_complete(
                        self._execute_code_via_atp(code, language)
                    )
