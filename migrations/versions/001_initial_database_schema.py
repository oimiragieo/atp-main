...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_violations_severity_detected", "compliance_violations", ["severity", "detected_at"], unique=False
    )
    op.create_index(
        op.f("ix_compliance_violations_detected_at"), "compliance_violations", ["detected_at"], unique=False
    )
    op.create_index(op.f("ix_compliance_violations_framework"), "compliance_violations", ["framework"], unique=False)
    op.create_index(
        op.f("ix_compliance_violations_resource_id"), "compliance_violations", ["resource_id"], unique=False
    )
