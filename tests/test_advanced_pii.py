...
from advanced_pii import (
    PIIType, DataClassification, RedactionAction, PIIMatch, RedactionPolicy,
    PIIDetector, PIIRedactor, AdvancedPIISystem, RedactionAuditEntry,
    detect_pii, redact_text, redact_object
)
...
class TestPIIRedactor:
    ...
    def test_text_redaction(self):
        ...
        redacted_text, audit_entry = redactor.redact_text(
            text, matches, DataClassification.CONFIDENTIAL
        )
...
class TestAdvancedPIISystem:
    ...
    def test_data_subject_request_export(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = system.handle_data_subject_request(
