...
def test_experiment_metadata_candidates_structure():
    ...
    candidates = [
        {"model": "gpt-4", "cost_per_1k": 0.03, "quality_pred": 0.80, "latency_p95": 1500},
        {"model": "claude-3", "cost_per_1k": 0.015, "quality_pred": 0.85, "latency_p95": 1200},
    ]
...
def test_experiment_metadata_plan_response_format():
    ...
    plan_response = {
        "type": "plan",
        "candidates": [{"model": "gpt-4", "cost_per_1k": 0.03, "quality_pred": 0.80, "latency_p95": 1500}],
        "cluster_hint": "us-east-1",
        "prompt_hash": "abc123",
        "reason": "cheapest acceptable then escalation (bandit)",
        "roles": [{"role": "primary", "model": "gpt-4"}, {"role": "challenger", "model": "claude-3"}],
    }
