...
from router_service.database_backup import BackupScheduler, DatabaseBackupManager
...
class TestDatabaseIntegration:
    ...
    def test_database_models_import(self):
        ...
        from router_service.models.database import AuditLog, ComplianceViolation, Policy, Provider, Request
