...
async def test_cache_manager_l1_only():
    ...
    config = CacheConfig(l1_enabled=True, l2_enabled=False, metrics_enabled=False)
...
async def test_cache_manager_with_mock_redis():
    ...
    config = CacheConfig(l1_enabled=True, l2_enabled=True, write_through=True, read_through=True, metrics_enabled=False)
...
async def test_cache_manager_invalidation():
    ...
    config = CacheConfig(l1_enabled=True, l2_enabled=False, invalidation_enabled=True, metrics_enabled=False)
...
async def test_cache_manager_write_strategies():
    ...
    config = CacheConfig(
        l1_enabled=True, l2_enabled=True, write_through=False, write_behind=True, metrics_enabled=False
    )
