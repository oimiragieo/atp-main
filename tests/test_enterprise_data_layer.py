...
def test_registry_migration_validation():
    ...
    from router_service.registry_migration import validate_migration
...
async def test_startup_initialization():
    ...
    with patch('router_service.startup.initialize_database') as mock_init_db, \
         ...
         patch('router_service.startup.initialize_registry_adapter') as mock_adapter, \
