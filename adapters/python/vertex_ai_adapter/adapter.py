...
from vertexai.vision_models import ImageGenerationModel, ImageTextModel

from ..base_adapter import BaseAdapter, AdapterCapability, AdapterResponse, AdapterError
...
class VertexAIAdapter(BaseAdapter):
    ...
    async def generate_text(
        ...
        stream: bool = False,
        **kwargs
    ) -> Union[AdapterResponse, AsyncIterator[AdapterResponse]]:
