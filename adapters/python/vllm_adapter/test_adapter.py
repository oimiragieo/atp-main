...
with patch("GPUtil.getGPUs", return_value=[]):
    from server import BatchProcessor, BatchRequest, GPUMonitor, VLLMAdapter, VLLMClient
...
class TestVLLMClient:
    ...
    async def test_get_models(self):
        ...
        mock_models_response = {"data": [{"id": "llama-2-7b"}, {"id": "llama-2-13b"}]}
    ...
    async def test_generate_text(self):
        ...
        mock_response_data = {"choices": [{"text": "Generated text response"}]}
        ...
        with patch("aiohttp.ClientSession.post") as mock_post:
            ...
            result = await client.generate(prompt="Test prompt", model="llama-2-7b", max_tokens=100)
    ...
    async def test_generate_stream(self):
        ...
        with patch("aiohttp.ClientSession.post") as mock_post:
            ...
            chunks = []
            async for chunk in client.generate_stream(prompt="Test prompt", model="llama-2-7b"):
                chunks.append(chunk)
...
class TestVLLMAdapter:
    ...
    def setup_method(self):
        ...
        with patch("server.GPUMonitor"), patch("server.BatchProcessor"), patch("server.VLLMClient"):
    ...
    async def test_estimate_request(self):
        ...
        prompt_json = json.dumps({"prompt": "Test prompt for estimation", "model": "llama-2-7b", "max_tokens": 100})
    ...
    async def test_health_request(self):
        ...
        with (
            patch.object(self.adapter.vllm_client, "__aenter__", return_value=self.adapter.vllm_client),
...
class TestIntegration:
    ...
    async def test_end_to_end_flow(self):
        ...
        with (
            patch("server.GPUMonitor") as mock_gpu_monitor,
            ...
            # Test estimate
            prompt_json = json.dumps({"prompt": "Hello, world!", "model": "llama-2-7b", "max_tokens": 50})
            ...
            # Test health
            with patch("psutil.cpu_percent", return_value=30.0), patch("psutil.virtual_memory") as mock_memory:
