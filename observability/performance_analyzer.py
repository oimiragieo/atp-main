...
class PerformanceAnalyzer:
    ...
    def analyze_critical_path(self, trace_id: str) -> Optional[CriticalPath]:
        ...
        bottleneck_operations = [
            op for op, duration in operation_durations.items()
            if duration > self.latency_thresholds['medium']
        ]
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        recent_bottlenecks = [
            b.to_dict() for b in self.detected_bottlenecks
        ...
        return {
            "summary": {
                ...
                "active_services": len(set(stats['service'] for stats in self.operation_stats.values())),
    ...
    def get_operation_insights(self, operation: str, service: Optional[str] = None) -> Dict[str, Any]:
        ...
        return {
            ...
            "recommendations": self._get_operation_recommendations(operation, all_durations, total_errors / total_calls if total_calls > 0 else 0)
        }
