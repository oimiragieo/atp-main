...
try:
    ...
    from opentelemetry.sdk.trace.sampling import TraceIdRatioBased, ParentBased, ALWAYS_OFF, ALWAYS_ON
...
class EnhancedTracer:
    ...
    def get_correlation_info(self, trace_id: str) -> Optional[TraceCorrelation]:
...
def get_tracer() -> Optional[EnhancedTracer]:
