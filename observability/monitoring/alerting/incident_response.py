...
class IncidentResponseAutomation:
    ...
    def _initialize_default_actions(self):
        ...
        default_actions = [
            RemediationAction(
                ...
                action_config={"service_name": "atp-router", "namespace": "default", "wait_for_ready": True},
                timeout_seconds=120,
            ...
            RemediationAction(
                ...
                action_config={"cache_type": "redis", "host": "redis-service", "port": 6379, "pattern": "atp:*"},
                timeout_seconds=60,
                requires_approval=False,
            ),
            RemediationAction(
                ...
                action_config={"service_name": "external-api", "failure_threshold": 5, "timeout_seconds": 60},
                timeout_seconds=30,
                requires_approval=False,
            ),
            RemediationAction(
                ...
                action_config={"service_name": "atp-router", "namespace": "default", "rollback_to": "previous"},
                timeout_seconds=600,
    ...
    async def trigger_remediation(
        ...
        for action in matching_actions:
            try:
                execution_id = await self._execute_remediation_action(action, incident_id, alert_id, context)
    ...
    async def execute_runbook(
        self, runbook_id: str, incident_id: str | None = None, context: dict[str, Any] | None = None
    ) -> str:
    ...
    async def _execute_runbook_step(self, step: RunbookStep, context: dict[str, Any] | None = None):
    ...
    async def _execute_script(self, config: dict[str, Any]) -> str:
        ...
        process = await asyncio.create_subprocess_exec(
            script_path, *args, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
        )
    ...
    def _is_rate_limited(self, action_id: str) -> bool:
        ...
        self.execution_counts[action_id] = [t for t in self.execution_counts[action_id] if t > hour_ago]
...
_incident_response: IncidentResponseAutomation | None = None
