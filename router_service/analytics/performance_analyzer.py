...
class PerformanceAnalyzer:
    ...
    async def _analyze_throughput(self, metrics: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        analysis["peak_analysis"] = {
            ...
            "peak_to_average_ratio": max(throughput_values) / statistics.mean(throughput_values) if throughput_values else 0
        }
    ...
    async def _analyze_sla_compliance(self, metrics: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        sla_analysis = {
            "sla_thresholds": self._sla_thresholds,
            "compliance_summary": {}
        }
    ...
    def _create_time_windows(self, metrics: List[Dict[str, Any]], window_size_minutes: int = 60) -> List[List[Dict[str, Any]]]:
