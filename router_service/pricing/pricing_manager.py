...
class PricingManager:
    ...
    async def validate_actual_cost(
        ...
        expected_result = await self.calculate_request_cost(
        ...
        expected_cost = expected_result["total_cost_usd"]
    ...
    async def get_system_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            health["pricing_monitoring"] = (
                health["components"]["monitor"]["status"] == "healthy" and
                health["staleness"]["stale_count"] < 10  # Arbitrary threshold
            )
...
async def initialize_pricing_manager(config: Optional[PricingConfig] = None) -> PricingManager:
