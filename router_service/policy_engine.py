...
class PolicyRule:
    ...
    resources: Optional[List[str]] = None  # Resource patterns this rule applies to
    actions: Optional[List[str]] = None    # Actions this rule applies to
...
class ABACPolicy:
    ...
    def evaluate(self, resource: str, action: str, attributes: Dict[str, Any]) -> Optional[Effect]:
