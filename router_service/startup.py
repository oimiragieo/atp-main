    ...
    try:
        ...
        if migrate_registry:
            if not registry_file_path:
                ...
                registry_file_path = os.path.join(os.path.dirname(__file__), "model_registry.json")
...
async def startup_health_check() -> dict:
    ...
    health_status = {"database": False, "repositories": False, "registry_adapter": False, "overall": False}
    ...
    try:
        ...
        health_status["overall"] = all(
            [health_status["database"], health_status["repositories"], health_status["registry_adapter"]]
        )
