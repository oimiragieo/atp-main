...
def _parse_json_preferences(value: Optional[str]) -> Optional[Dict[str, Dict[str, float]]]:
...
LOCAL_MODEL_INDICATORS = [
    "llama", "mistral", "vicuna", "alpaca", "falcon", "mpt", "dolly",
    "stablelm", "redpajama", "openchat", "wizard", "orca", "phi"
]
