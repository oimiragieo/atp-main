...
class DatabaseBackupManager:
    ...
    async def create_incremental_backup(self, base_backup: str, backup_name: str | None = None) -> str:
    ...
    async def restore_backup(self, backup_file: str, target_database: str | None = None) -> bool:
    ...
    async def _backup_loop(self) -> None:
        ...
        while self.running:
            try:
                ...
                if not last_full_backup or (now - last_full_backup).total_seconds() >= self.full_backup_interval * 3600:
                ...
                # Check if incremental backup is needed
                    ...
                    or (now - last_incremental_backup).total_seconds() >= self.incremental_backup_interval * 3600
                ):
...
_backup_manager: DatabaseBackupManager | None = None
