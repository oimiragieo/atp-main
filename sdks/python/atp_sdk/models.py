...
class ChatRequest(BaseModel):
    ...
    functions: list[dict[str, Any]] | None = Field(None, description="Available functions")
    function_call: str | dict[str, str] | None = Field(None, description="Function call preference")
    tools: list[dict[str, Any]] | None = Field(None, description="Available tools")
    tool_choice: str | dict[str, Any] | None = Field(None, description="Tool choice preference")
    user: str | None = Field(None, description="User identifier for tracking")

    # ATP-specific parameters
    cost_limit: float | None = Field(None, description="Maximum cost for this request")
    quality_preference: str | None = Field(None, description="Quality preference (speed, balanced, quality)")
...
class ChatResponse(BaseModel):
    ...
    cost: float | None = Field(None, description="Cost of the request")
...
class ProviderStatus(BaseModel):
    ...
    latency: float | None = Field(None, description="Average latency in seconds")
...
class ImageGenerationRequest(BaseModel):
    ...
    model: str | None = Field(None, description="Image generation model")
